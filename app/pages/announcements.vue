...
<template>
  <div class="flex min-h-screen bg-bg-light">
    ...
    <div class="flex-1 ml-64 mr-80">
      <div class="p-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">圈子</h1>
        <div class="bg-white rounded-2xl p-8 text-center">
          <i class="fa-solid fa-users text-6xl text-gray-200 mb-4"></i>
          <p class="text-gray-500">加入圈子</p>
          <p class="text-sm text-gray-400 mt-2">发现志同道合的朋友</p>
        </div>
      </div>
    </div>
